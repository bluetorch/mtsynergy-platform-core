...
describe('PII Sanitizers', () => {
  ...
  describe('maskIdentifier', () => {
    ...
    it('should mask credit card XXXX-XXXX-XXXX-XXXX', () => {
    ...
    it('should mask multiple identifiers', () => {
      const input = 'SSN: 123-45-6789 and CC: 4111-1111-1111-1111'
      const result = maskIdentifier(input)
    ...
    it('should use custom replacement token', () => {
      const input = 'SSN: 123-45-6789'
      const result = maskIdentifier(input, '[SSN]')
    ...
    it('should return passthrough when no identifiers present', () => {
    ...
    it('should handle long API key patterns', () => {
      const input = 'key: abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'
      const result = maskIdentifier(input)
      expect(result).toContain('[REDACTED-IDENTIFIER]')
    })

    it('should handle JWT-like patterns', () => {
      const input = 'JWT: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ'
      const result = maskIdentifier(input)
      expect(result).toContain('[REDACTED-IDENTIFIER]')
    })

    it('should not match short sequences', () => {
      const input = 'Short: abc123def'
      const result = maskIdentifier(input)
      expect(result).toBe(input)
    })
  })
  ...
  describe('Integration Tests', () => {
    ...
    it('should sanitize form submission with sensitive data', () => {
      const formData = {
        firstName: 'John',
        lastName: 'Doe',
        email: 'john@example.com',
        phone: '(555) 123-4567',
        ssn: '123-45-6789',
        address: 'test@example.com street',
      }
    ...
    it('should sanitize error log with sensitive data', () => {
      ...
      const passwordPattern: PiiPattern = {
        name: 'password',
      ...
      const result = scrubObject(errorLog, [emailPattern, passwordPattern])
